...
Цитатът се огражда с двойката маркери `C>` и `C$`. Освен за цитат, маркерите се използват за обособен текст от типа бележка, статия, писмо, цитиран дневник и др.

Цитат може да се появява само в тялото на [секция](/docs/sfb/section), [анотация](/docs/sfb/annotation) или [информационен блок](/docs/sfb/info).
