...
уеб-страница следния текст — «Глава първа», ще трябва да напишете 
„<h2>Глава първа</h2>“, ако решите да бъде някое уики се 
налага да смените командата на „==Глава първа==“ и т.н. при всеки 
...
1.  Форматът SFB може да се използва с всеки текстов редактор, 
    маркерите не «досаждат» при корекция, а правилата осигуряват еднозначно 
    конвертиране към желаните изходни формати (ePub, mobi и т.н.).
